...
<html>
    ...
    <body>
        ...
        <form method="POST" action="processapp.php" onsubmit="return validateForm()" name="myform">
            <div class="text1">First Name : <input type="text" name="firstname" class="form-control" autocomplete="off"></div>
            <br><br>
            <div class="text2">Last Name : <input type="text" name="lastname" class="form-control" autocomplete="off"></div>
            <br><br>
            ...
            <br><br>
            <div class="text4">Age : <input type="number" name="age" class="form-control" autocomplete="off"></div>
            <br><br>
            <div class="text5">Date Of Birth : <input type="text" name="dateofbirth" class="form-control" autocomplete="off"></div>
            <br><br>
            <div class="text6">Monthly Income : <input type="number" name="monthlyincome" class="form-control" autocomplete="off"></div>
            <br><br>
            <div class="text7">Loan Amount Needed : <input type="number" name="loanamountneeded" class="form-control" autocomplete="off"></div>
            <br><br>
            ...
            <br><br>
           <div class="text9">Tenure : <br><br><input type="radio" name="tenure" value="6 Months" class = "one"><label style="position: relative; top: 2px; left:9px; color: black;">6 Months</label><br>
